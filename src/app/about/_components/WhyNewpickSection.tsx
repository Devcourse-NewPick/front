...
function WhyNewpickSection({ className }: Props) {
	return (
		<WhyNewpickSectionStyled className={className}>
			...
			<div className="design-text">Value Proposition</div>
			<div className="value-text">
				<p>
					<strong>최신 트렌드</strong>와 이슈를 놓치지 않도록
				</p>
				<p>
					<strong>빠르고 정확하게</strong> 뉴스를 습득할 수 있도록
				</p>
				<p>
					나만의 관심 분야를 <strong>더 깊이 탐구</strong>할 수 있도록
				</p>
			</div>
