(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_d77afe._.js", {
...
function MySubscribe() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "MySubscribe.useEffect": ()=>{
            ...
            // .my-subs-content 클래스를 가진 모든 섹션 선택
            const sections = document.querySelectorAll(".my-subs-content");
            // Observer 콜백
            const handleIntersect = {
                "MySubscribe.useEffect.handleIntersect": (entries)=>{
                    entries.forEach({
                        "MySubscribe.useEffect.handleIntersect": (entry)=>{
                            // isIntersecting: 해당 섹션이 threshold만큼 화면에 보이면 true
                            if (entry.isIntersecting) {
                                // entry.target => 관찰 중인 섹션 DOM
                                setActiveCategory(entry.target.id);
                            }
                        }
                    }["MySubscribe.useEffect.handleIntersect"]);
                }
            }["MySubscribe.useEffect.handleIntersect"];
            // Observer 옵션
            const options = {
...
//# sourceMappingURL=src_d77afe._.js.map