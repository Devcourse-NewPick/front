(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_5da1be._.js", {
...
const HomePage = ()=>{
    ...
    const fetchNewsletters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "HomePage.useCallback[fetchNewsletters]": (page)=>{
            const startIndex = (page - 1) * ITEMS_PER_PAGE;
            const endIndex = page * ITEMS_PER_PAGE;
            return newsletters.slice(startIndex, endIndex);
        }
    }["HomePage.useCallback[fetchNewsletters]"], [
        newsletters
    ]);
                ...
                "HomePage.useEffect": ([entry])=>{
                    if (entry.isIntersecting && !isLoading) {
                        ...
                        setTimeout({
                            "HomePage.useEffect": ()=>{
                                setCurrentPage({
                                    "HomePage.useEffect": (prevPage)=>prevPage + 1
                                }["HomePage.useEffect"]);
                                setIsLoading(false);
                            }
                        }["HomePage.useEffect"], 1500); // 데이터 로드 지연 (1.5초)
                    }
                }
            }["HomePage.useEffect"], {
                threshold: 1.0
...
_s(HomePage, "rD/V6zX0U0cHPkq6OHtUfd3rc7k=", false, function() {
    return [
...
"[project]/src/app/newsletter/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=src_5da1be._.js.map