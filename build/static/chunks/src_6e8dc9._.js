(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_6e8dc9._.js", {
...
const NewsletterPage = ()=>{
    ...
    const todayTrends = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "NewsletterPage.useMemo[todayTrends]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$queryNewsletters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterTodayTrends"])(newsletters)
    }["NewsletterPage.useMemo[todayTrends]"], [
        newsletters
    ]);
    const topTrends = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$queryNewsletters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["filterTopTrends"])(newsletters);
                ...
                setLoadedNewsletters({
                    "NewsletterPage.useEffect": (prev)=>{
                        ...
                        const existingIds = new Set(prev.map({
                            "NewsletterPage.useEffect": (item)=>item.id
                        }["NewsletterPage.useEffect"]));
                        const uniqueItems = newItems.filter({
                            "NewsletterPage.useEffect.uniqueItems": (item)=>!existingIds.has(item.id)
                        }["NewsletterPage.useEffect.uniqueItems"]);
                        return [
                            ...prev,
                            ...uniqueItems
                        ];
    ...
    const sortedNewsletters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$queryNewsletters$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sortNewsletters"])(loadedNewsletters, selectedSort);
...
_s(NewsletterPage, "ahVf9i2XSwVzQif8IXq+z3CQzbA=", false, function() {
    return [
...
//# sourceMappingURL=src_6e8dc9._.js.map