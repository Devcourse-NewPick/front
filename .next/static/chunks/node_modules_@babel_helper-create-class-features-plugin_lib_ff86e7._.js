(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_@babel_helper-create-class-features-plugin_lib_ff86e7._.js", {

"[project]/node_modules/@babel/helper-create-class-features-plugin/lib/typescript.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@babel/helper-create-class-features-plugin/lib/fields.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var ts = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/typescript.js [app-client] (ecmascript)");
{
    var newHelpers = (file)=>{
        ;
...
function buildCheckInRHS(rhs, file, inRHSIsObject) {
    ...
    return _core.types.callExpression(file.addHelper("checkInRHS"), [
        rhs
    ]);
}
...
function readOnlyError(file, name) {
    return _core.types.callExpression(file.addHelper("readOnlyError"), [
        _core.types.stringLiteral(`#${name}`)
    ]);
}
function writeOnlyError(file, name) {
    ...
    return _core.types.callExpression(file.addHelper("writeOnlyError"), [
        _core.types.stringLiteral(`#${name}`)
    ]);
}
...
const privateNameHandlerSpec = {
    ...
    get: autoInherits(function(member) {
        const { classRef, privateNamesMap, file, innerBinding, noUninitializedPrivateFieldAccess } = this;
        ...
        if (isStatic) {
            ...
            if (!isMethod) {
                ...
                return buildStaticPrivateFieldAccess(_core.types.callExpression(file.addHelper("assertClassBrand"), [
                    _core.types.cloneNode(classRef),
                    receiver,
                    cloneId(id)
            ...
            if (getId) {
                if (skipCheck) {
                    return _core.types.callExpression(cloneId(getId), [
                        receiver
                    ]);
                }
                return _core.types.callExpression(file.addHelper("classPrivateGetter"), [
                    _core.types.cloneNode(classRef),
                    receiver,
                    cloneId(getId)
                ]);
            ...
            return _core.types.callExpression(file.addHelper("assertClassBrand"), [
                _core.types.cloneNode(classRef),
                receiver,
                cloneId(id)
            ]);
        ...
        if (newHelpers(file)) {
            return _core.types.callExpression(file.addHelper("classPrivateFieldGet2"), [
                cloneId(id),
                this.receiver(member)
            ]);
        }
    ...
    set: autoInherits(function(member, value) {
        const { classRef, privateNamesMap, file, noUninitializedPrivateFieldAccess } = this;
        const privateName = member.node.property;
        const { name } = privateName.id;
        ...
        if (isStatic) {
            ...
            if (isMethod && !setId) {
                ...
                if (skipCheck) return _core.types.sequenceExpression([
                    value,
                    err
                ]);
                return _core.types.sequenceExpression([
            ...
            if (setId) {
                if (skipCheck) {
                    return _core.types.callExpression(_core.types.cloneNode(setId), [
                        receiver,
                        value
                    ]);
                }
                return _core.types.callExpression(file.addHelper("classPrivateSetter"), [
                    _core.types.cloneNode(classRef),
                    cloneId(setId),
                    receiver,
                    value
            ...
            return _core.types.assignmentExpression("=", buildStaticPrivateFieldAccess(cloneId(id), noUninitializedPrivateFieldAccess), skipCheck ? value : _core.types.callExpression(file.addHelper("assertClassBrand"), [
                _core.types.cloneNode(classRef),
                receiver,
                value
            ]));
        ...
        if (newHelpers(file)) {
            return _core.types.callExpression(file.addHelper("classPrivateFieldSet2"), [
                cloneId(id),
                this.receiver(member),
                value
            ]);
    ...
    destructureSet (member) {
        ...
        if (!newHelpers(file)) {
            ...
            return _core.types.memberExpression(_core.types.callExpression(file.addHelper("classPrivateFieldDestructureSet"), [
                this.receiver(member),
                cloneId(id)
            ]), _core.types.identifier("value"));
        }
        if (isMethod && !setId) {
            return _core.types.memberExpression(_core.types.sequenceExpression([
                member.node.object,
                readOnlyError(file, name)
        ...
        if (isStatic && !isMethod) {
            ...
            return _core.types.memberExpression(_core.types.callExpression(file.addHelper("toSetter"), [
                getCall
            ]), _core.types.identifier("_"));
        }
        ...
        if (_core.types.isMemberExpression(setCall.callee, {
            ...
            args = [
                setCall.callee,
                _core.types.arrayExpression(setCall.arguments.slice(0, -1))
            ];
        }
...
function transformPrivateNamesUsage(ref, path, privateNamesMap, { privateFieldsAsProperties, noUninitializedPrivateFieldAccess, noDocumentAll, innerBinding }, state) {
...
function buildPrivateInstanceFieldInitSpec(ref, prop, privateNamesMap, state) {
    ...
    return inheritLoc(inheritPropComments(_core.types.expressionStatement(_core.types.callExpression(helper, [
        ...
        newHelpers(state) ? value : _core.template.expression.ast`{ writable: true, value: ${value} }`
    ])), prop), prop.node);
}
function buildPrivateStaticFieldInitSpec(prop, privateNamesMap, noUninitializedPrivateFieldAccess) {
    ...
    return inheritPropComments(_core.types.variableDeclaration("var", [
        _core.types.variableDeclarator(_core.types.cloneNode(privateName.id), value)
    ]), prop);
}
{
...
"[project]/node_modules/@babel/helper-create-class-features-plugin/lib/misc.js [app-client] (ecmascript)": (function(__turbopack_context__) {
    ...
    if (isDerived) {
        ...
        for (const bareSuper of bareSupers){
            ...
            if (!bareSuper.parentPath.isExpressionStatement()) {
                const allNodes = [
                    bareSuper.node,
                    ...nodes.map((n)=>_core.types.toExpression(n))
                ];
...
"[project]/node_modules/@babel/helper-create-class-features-plugin/lib/decorators.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var _helperReplaceSupers = __turbopack_require__("[project]/node_modules/@babel/helper-replace-supers/lib/index.js [app-client] (ecmascript)");
var _helperSkipTransparentExpressionWrappers = __turbopack_require__("[project]/node_modules/@babel/helper-skip-transparent-expression-wrappers/lib/index.js [app-client] (ecmascript)");
var _fields = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/fields.js [app-client] (ecmascript)");
var _misc = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/misc.js [app-client] (ecmascript)");
...
function replaceClassWithVar(path, className) {
    ...
    if (path.type === "ClassDeclaration") {
        ...
        const [newPath] = path.replaceWith(_core.types.sequenceExpression([
            newClassExpr,
            varId
        ]));
        return {
...
function addProxyAccessorsFor(className, element, getterKey, setterKey, targetKey, isComputed, isStatic, version) {
    ...
    const getterBody = _core.types.blockStatement([
        _core.types.returnStatement(_core.types.memberExpression(_core.types.cloneNode(thisArg), _core.types.cloneNode(targetKey)))
    ]);
    const setterBody = _core.types.blockStatement([
        _core.types.expressionStatement(_core.types.assignmentExpression("=", _core.types.memberExpression(_core.types.cloneNode(thisArg), _core.types.cloneNode(targetKey)), _core.types.identifier("v")))
    ]);
    let getter, setter;
    if (getterKey.type === "PrivateName") {
        getter = _core.types.classPrivateMethod("get", getterKey, [], getterBody, isStatic);
        setter = _core.types.classPrivateMethod("set", setterKey, [
            _core.types.identifier("v")
        ], setterBody, isStatic);
    } else {
        getter = _core.types.classMethod("get", getterKey, [], getterBody, isComputed, isStatic);
        setter = _core.types.classMethod("set", setterKey, [
            _core.types.identifier("v")
        ], setterBody, isComputed, isStatic);
    }
    ...
    if (completion.isConstantExpression()) {
        ...
        if (!maybeAssignment) {
            ...
            if (completionParent.isSequenceExpression()) {
                ...
                completion.replaceWith(maybeSequenceExpression([
...
function optimizeSuperCallAndExpressions(expressions, protoInitLocal) {
    if (protoInitLocal) {
        if (expressions.length >= 2 && isProtoInitCallExpression(expressions[1], protoInitLocal)) {
            const mergedSuperCall = _core.types.callExpression(_core.types.cloneNode(protoInitLocal), [
                expressions[0]
            ]);
...
function createConstructorFromExpressions(expressions, isDerivedClass) {
    ...
    if (isDerivedClass) {
        body.unshift(_core.types.expressionStatement(_core.types.callExpression(_core.types.super(), [
            _core.types.spreadElement(_core.types.identifier("args"))
        ])));
    }
    return _core.types.classMethod("constructor", _core.types.identifier("constructor"), isDerivedClass ? [
        _core.types.restElement(_core.types.identifier("args"))
...
function toSortedDecoratorInfo(info) {
    return [
        ...info.filter((el)=>el.isStatic && el.kind >= ACCESSOR && el.kind <= SETTER),
        ...info.filter((el)=>!el.isStatic && el.kind >= ACCESSOR && el.kind <= SETTER),
...
function addCallAccessorsFor(version, element, key, getId, setId, isStatic) {
    element.insertAfter(_core.types.classPrivateMethod("get", _core.types.cloneNode(key), [], _core.types.blockStatement([
        _core.types.returnStatement(_core.types.callExpression(_core.types.cloneNode(getId), version === "2023-11" && isStatic ? [] : [
            _core.types.thisExpression()
        ]))
    ]), isStatic));
    element.insertAfter(_core.types.classPrivateMethod("set", _core.types.cloneNode(key), [
        _core.types.identifier("v")
    ], _core.types.blockStatement([
        _core.types.expressionStatement(_core.types.callExpression(_core.types.cloneNode(setId), version === "2023-11" && isStatic ? [
            _core.types.identifier("v")
        ] : [
            _core.types.thisExpression(),
            _core.types.identifier("v")
...
function movePrivateAccessor(element, key, methodLocalVar, isStatic) {
    ...
    if (element.node.kind === "set") {
        ...
        block = [
            _core.types.expressionStatement(_core.types.callExpression(methodLocalVar, [
                _core.types.thisExpression(),
                _core.types.identifier("v")
            ]))
        ];
        ...
        params = [];
        block = [
            _core.types.returnStatement(_core.types.callExpression(methodLocalVar, [
                _core.types.thisExpression()
            ]))
        ];
    }
...
function fieldInitializerToClosure(value) {
    return _core.types.functionExpression(null, [], _core.types.blockStatement([
        _core.types.returnStatement(value)
    ]));
}
...
function createPrivateBrandCheckClosure(brandName) {
    return _core.types.arrowFunctionExpression([
        _core.types.identifier("_")
    ], _core.types.binaryExpression("in", _core.types.cloneNode(brandName), _core.types.identifier("_")));
}
...
function transformClass(path, state, constantSuper, ignoreFunctionLength, className, propertyVisitor, version) {
    ...
    if (!classDecorators && !hasElementDecorators) {
        ...
        if (setClassName) {
            path.node.body.body.unshift(createStaticBlockFromExpressions([
    ...
    if (classDecorators) {
        ...
        const { hasSideEffects, usesFnContext, decoratorsThis } = handleDecorators(classDecorators);
        const { haveThis, decs } = generateDecorationList(classDecorators, decoratorsThis, version);
    ...
    if (hasElementDecorators) {
        ...
        for (const element of body){
            ...
            if (hasDecorators) {
                const { hasSideEffects, usesFnContext, decoratorsThis } = handleDecorators(decorators);
                const { decs, haveThis } = generateDecorationList(decorators, decoratorsThis, version);
            ...
            if (hasDecorators) {
                ...
                if (kind === ACCESSOR) {
                    ...
                    const params = version === "2023-11" && isStatic ? [] : [
                        _core.types.thisExpression()
                    ];
                    if (value) {
                    ...
                    const args = version === "2023-11" && isStatic ? [] : [
                        _core.types.thisExpression()
                    ];
            ...
            if (hasDecorators && version === "2023-11") {
                if (kind === FIELD || kind === ACCESSOR) {
                    ...
                    const initExtraCall = _core.types.callExpression(_core.types.cloneNode(initExtraId), isStatic ? [] : [
                        _core.types.thisExpression()
                    ]);
                    if (!isStatic) {
    ...
    if (classDecorators) {
        ...
        path.get("body.body").forEach((element)=>{
            if (element.isStaticBlock()) {
                if (hasInstancePrivateAccess(element, instancePrivateNames)) {
                    ...
                    staticFieldInitializerExpressions.push(_core.types.callExpression(_core.types.memberExpression(staticBlockClosureId, _core.types.identifier("call")), [
                        _core.types.thisExpression()
                    ]));
                } else {
            ...
            if ((element.isClassProperty() || element.isClassPrivateProperty()) && element.node.static) {
                ...
                if (hasInstancePrivateAccess(valuePath, instancePrivateNames)) {
                    ...
                    valuePath.replaceWith(_core.types.callExpression(_core.types.memberExpression(fieldValueClosureId, _core.types.identifier("call")), [
                        _core.types.thisExpression()
                    ]));
                }
                if (staticFieldInitializerExpressions.length > 0) {
                ...
                if (hasInstancePrivateAccess(element, instancePrivateNames)) {
                    ...
                    if (ignoreFunctionLength) {
                        ...
                        element.node.body = _core.types.blockStatement([
                            _core.types.returnStatement(_core.types.callExpression(_core.types.memberExpression(privateMethodDelegateId, _core.types.identifier("apply")), [
                                _core.types.thisExpression(),
                                _core.types.identifier("arg")
                            ]))
                        ]);
                    } else {
      ...
      `;
            staticsClass.body.body = [
                _core.types.classProperty(_core.types.toExpression(originalClass), undefined, undefined, undefined, true, true),
                ...statics
            ];
            ...
            if (constructorBody.length > 0) {
                constructorBody.unshift(_core.types.callExpression(_core.types.super(), [
    ...
    if (!classInitInjected && classInitCall) {
        path.node.body.body.push(_core.types.staticBlock([
            _core.types.expressionStatement(classInitCall)
        ]));
    }
    ...
    if (computedKeyAssignments.length > 0) {
        ...
        if (firstPublicElement != null) {
            ...
            originalClass.body.body.unshift(_core.types.classProperty(_core.types.sequenceExpression([
                ...computedKeyAssignments,
    ...
    if (staticInitLocal) {
        applyDecsBody.push(_core.types.expressionStatement(_core.types.callExpression(_core.types.cloneNode(staticInitLocal), [
            _core.types.thisExpression()
        ])));
    }
    ...
    if (needsDeclaraionForClassBinding) {
        ...
        if (!classBindingInfo.constantViolations.length) {
            path.insertBefore(_core.types.variableDeclaration("let", [
            ...
            path.replaceWithMultiple([
                _core.types.variableDeclaration("let", [
                    _core.types.variableDeclarator(_core.types.cloneNode(classOuterBindingLocal)),
...
function createLocalsAssignment(elementLocals, classLocals, elementDecorations, classDecorations, classDecorationsFlag, maybePrivateBrandName, setClassName, superClass, state, version) {
    let lhs, rhs;
    const args = [
        setClassName ? createSetFunctionNameCall(state, setClassName) : _core.types.thisExpression(),
        classDecorations,
        elementDecorations
    ];
    {
    ...
    if (elementLocals.length > 0) {
        if (classLocals.length > 0) {
            lhs = _core.types.objectPattern([
                _core.types.objectProperty(_core.types.identifier("e"), _core.types.arrayPattern(elementLocals)),
                _core.types.objectProperty(_core.types.identifier("c"), _core.types.arrayPattern(classLocals))
            ]);
        } else {
                ...
                if ((declaration == null ? void 0 : declaration.type) === "ClassDeclaration" && isDecorated(declaration)) {
                    {
                        ...
                        (_path$splitExportDecl2 = path.splitExportDeclaration) != null ? _path$splitExportDecl2 : path.splitExportDeclaration = __turbopack_require__("[project]/node_modules/@babel/traverse/lib/index.js [app-client] (ecmascript)").NodePath.prototype.splitExportDeclaration;
                    }
...
"[project]/node_modules/@babel/helper-create-class-features-plugin/lib/decorators-2018-09.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/node_modules/@babel/helper-create-class-features-plugin/lib/features.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var _decorators = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/decorators-2018-09.js [app-client] (ecmascript)");
...
"[project]/node_modules/@babel/helper-create-class-features-plugin/lib/index.js [app-client] (ecmascript)": (function(__turbopack_context__) {
...
var _core = __turbopack_require__("[project]/node_modules/@babel/core/lib/index.js [app-client] (ecmascript)");
var _decorators = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/decorators.js [app-client] (ecmascript)");
var _semver = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/node_modules/semver/semver.js [app-client] (ecmascript)");
var _fields = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/fields.js [app-client] (ecmascript)");
var _decorators2 = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/decorators-2018-09.js [app-client] (ecmascript)");
var _misc = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/misc.js [app-client] (ecmascript)");
var _features = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/features.js [app-client] (ecmascript)");
var _typescript = __turbopack_require__("[project]/node_modules/@babel/helper-create-class-features-plugin/lib/typescript.js [app-client] (ecmascript)");
const versionKey = "@babel/plugin-class-features/version";
function createClassFeaturePlugin({ name, feature, loose, manipulateOptions, api, inherits, decoratorVersion }) {
    var _api$assumption;
            ...
            Class (path, { file }) {
                ...
                let keysNodes, staticNodes, instanceNodes, lastInstanceNodeReturnsThis, pureStaticNodes, classBindingNode, wrapClass;
                {
                    if (isDecorated) {
                        ...
                        ({ instanceNodes, wrapClass } = (0, _decorators2.buildDecoratedClass)(classRefForDefine, path, elements, file));
                    } else {
...
//# sourceMappingURL=node_modules_%40babel_helper-create-class-features-plugin_lib_ff86e7._.js.map